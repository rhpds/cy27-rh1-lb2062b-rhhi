...
2. Edit `galaxy.yml` — replace `cy27_rh1_lb2062b_rhhi`, `automation`, and
   the author line. These become the prefix for every role's fully qualified name
   (`cy27_rh1_lb2062b_rhhi.automation.<role_name>`).
...
- name: Run my_role_name
  ansible.builtin.include_role:
    name: cy27_rh1_lb2062b_rhhi.automation.my_role_name
```
